...
import { classes, colours, difficulties, pieces, players, statuses } from './constants';
...
export class Board extends React.Component {
    ...
    if (this.props.colour === colours.white) {
      return (
        <div className={classes.chess}>
          ...
          <MoveLog moves={this.state.moves} />
        </div>
      );
    }
  }
  ...
  handleClick(row, col) {
    if ((this.state.turn === this.props.colour) && (this.state.board[row][col].substr(0, 1) === this.props.colour)) {
      ...
      newMoves.unshift([players.player,
                        [rowCurrent, colCurrent],
                        [row, col],
                        newBoard[rowCurrent][colCurrent],
                        newBoard[row][col]]);
      ...
      newMoves.unshift([players.opponent,
                        [opponentMove[0][0], opponentMove[0][1]],
                        [opponentMove[1][0], opponentMove[1][1]],
                        newBoard[opponentMove[0][0]][opponentMove[0][1]],
                        newBoard[opponentMove[1][0]][opponentMove[1][1]]]);
